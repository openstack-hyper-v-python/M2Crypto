...
# endif
  ...
  SWIG_Python_SetConstant(d, "OPENSSL_VERSION_NUMBER",SWIG_From_long((long)(0x1000107fL)));
  SWIG_Python_SetConstant(d, "OPENSSL_VERSION_TEXT",SWIG_FromCharPtr("OpenSSL 1.0.1g 7 Apr 2014"));
  SWIG_Python_SetConstant(d, "OPENSSL_VERSION_PTEXT",SWIG_FromCharPtr(" part of OpenSSL 1.0.1g 7 Apr 2014"));
  SWIG_Python_SetConstant(d, "SHLIB_VERSION_HISTORY",SWIG_FromCharPtr(""));
  SWIG_Python_SetConstant(d, "SHLIB_VERSION_NUMBER",SWIG_FromCharPtr("1.0.0"));
